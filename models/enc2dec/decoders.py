...
from models.enc2dec.base_modules import BaseRNN
...
class DecoderRNN(BaseRNN):
    ...
    def forward(self, batch_size, inputs=None, init_state=None,
                ...
                beam_size=4, latent_variable=None,feature_input=None):
        # sanity checks
        ret_dict = dict()
        self.max_length = inputs.size(1)
